...
namespace TredeWeb.Controllers
{
    ...
    public class ApiFnCsFichesController : Controller
    {
        ...
        private void PopulateModel(FnCsFiches model, IDictionary values) {
            ...
            string CS_FİCHE_TYPE = nameof(FnCsFiches.CsFicheType);
            string DESCRİPTİON = nameof(FnCsFiches.Description);
            string FİNANCE_REF = nameof(FnCsFiches.FinanceRef);
            ...
            string FİCHE_DATE = nameof(FnCsFiches.FicheDate);
            string IS_ACTİVE = nameof(FnCsFiches.IsActive);
            ...
            if(values.Contains(CS_FİCHE_TYPE)) {
                model.CsFicheType = values[CS_FİCHE_TYPE] != null ? Convert.ToInt32(values[CS_FİCHE_TYPE]) : (int?)null;
            }
